...
var Chart = function(context){
	...
	//高像素密度显示-将画布高度/宽度的大小乘以设备像素比率，然后缩放。
	...
	var PolarArea = function(data,config,ctx){
		...
		function calculateDrawingSizes(){
			...
			//如果我们正在绘制背景-将Y填充添加到标签高度并从绘图区域中移除。
			...
			scaleHeight = maxSize;
			//如果标签高度小于5，则将其设置为5，这样我们就不会在彼此上方有行。
